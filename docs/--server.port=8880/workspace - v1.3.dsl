workspace {
    ...
    model {
        ...
        plmLite = softwareSystem "PLM Lite System" {
            ...
            user -> reactFrontend "Uses the web app"
    ...
    views {
        ...
        // Dynamic View: Document Approval Workflow
        dynamic plmLite {
        ...
        // Dynamic View: Change Approval Workflow
        dynamic plmLite {
            description "Shows the end-to-end change approval workflow"

            apiGateway -> changeService "Submits change request"
        ...
        // Dynamic View: PBS Creation Workflow
        dynamic plmLite {
            description "Shows the end-to-end Part/BOM (PBS) creation workflow"

            apiGateway -> bomService "Submits new part/BOM request"
            bomService -> documentService "References linked documents"
        }
